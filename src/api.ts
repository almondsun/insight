...
export type FameFoundationStatus={implementationStage:"synthetic_foundation";formulaVersion:string;protocolSchemaVersion:number;fixedCorpusRecordBytes:number;networkRetrievalAvailable:false};
