...
export const api={
  ...
  changes:(fromSnapshotId:number,toSnapshotId:number,category:string,search:string,after:string|null=null,limit=200)=>invoke<ChangePage>("compare_snapshots",{fromSnapshotId,toSnapshotId,category,search,after,limit}),
